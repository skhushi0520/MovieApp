...
class MovieListViewModel @Inject constructor(private val movieListRepository: MovieListRepository) :
    ...
    fun onEvemt(event: MovieListUiEvent) {
        when (event) {
            ...
            is MovieListUiEvent.Paginate -> {
                if (event.category == com.example.movieapplication.util.Category.POPULAR) {
                    getPopularMovieList(true)
                } else if (event.category == com.example.movieapplication.util.Category.UPCOMING) {
    ...
    private fun getUpcomingMovieList(forceFetchFromRemote: Boolean) {
        viewModelScope.launch {
            ...
            movieListRepository.getMovieList(
                forceFetchFromRemote, com.example.movieapplication.util.Category.UPCOMING,
    ...
    private fun getPopularMovieList(forceFetchFromRemote: Boolean) {
        viewModelScope.launch {
            ...
            movieListRepository.getMovieList(
                forceFetchFromRemote, com.example.movieapplication.util.Category.POPULAR,
